...
class PhoneValidatorTest {
    ...
    class Invalid {
        ...
        @ValueSource(strings = {
                "7 999 123-45-67",        // нет +
                "+7 999 123456789",       // основной: 9 цифр (слишком много)
                "+7 999 1234567890",      // основной: 10 цифр
                ...
                "+1 2 345",              // основной: 3 цифры (меньше минимума)
                "+7 999 123",            // основной: 3 цифры при разделителях
                "+1234 56 78901",        // код страны: 4 цифры (больше максимума)
                "+7-999-12345678901",    // основной: 11 цифр при разделителях
        })
